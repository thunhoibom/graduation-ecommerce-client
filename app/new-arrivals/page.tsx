...
export async function generateMetadata(_props: Props): Promise<Metadata> {
  return {
    title: "Hàng mới về — Mono Studio",
    description:
      "Sản phẩm mới nhất tại Mono Studio. Khám phá những thiết kế tươi mới cho mùa mới.",
  };
}

const NEW_ARRIVALS_COLLECTION: Collection = {
  name: "Hàng mới về",
  code: "new-arrivals",
  children: [],
};
...
export default async function NewArrivalsPage({ searchParams }: Props) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 lg:px-6">
      {/* Breadcrumb trail */}
      <div className="mb-5">
        <Breadcrumb collection={NEW_ARRIVALS_COLLECTION} />
      </div>

      {/* NEW ARRIVALS banner */}
      <div className="mb-8 flex items-center gap-3 border-b border-neutral-200 pb-6 dark:border-neutral-800">
        <span className="inline-block rounded-none bg-neutral-900 px-3 py-1 text-xs font-semibold tracking-widest text-white dark:bg-white dark:text-black uppercase">
          New Arrivals
        </span>
        <p className="text-sm text-neutral-500">
          Khám phá những thiết kế tươi mới cho mùa mới.
        </p>
      </div>
